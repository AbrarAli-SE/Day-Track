// src/styles/payout/addPayoutModalStyles.ts

import { StyleSheet } from 'react-native';
import Colors from '../../constants/colors';
import typography from '../../constants/typography';

export const addPayoutModalStyles = StyleSheet.create({
    modalOverlay: {
        flex: 1,
...
export default addPayoutModalStyles;